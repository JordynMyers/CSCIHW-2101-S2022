...
public class BankAccount {
  ...
  System.out.println("Balance: " + feeBalance2);
   ...
   System.out.println("Invalid entry");
    ...
    public void transfer(double bankAccount1, double 
    bankAccount2, double transferAmount){
    double balance1 = bankAccount1 - transferAmount;
// balance 1 is the amount in Bank Account 1 after the transfer to Bank Account 2
    double balance2 = bankAccount2 + transferAmount;
// balance2 is the amount in Bank Account 2 after the transfer to Bank Account 1
